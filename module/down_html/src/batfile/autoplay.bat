...
start /B python action_video.py --ip 127.0.0.1:9126 --isheadless 1 --isplay 1 --issave 0  > log/logplay9125.txt
start /B python action_video.py --ip 127.0.0.1:9127 --isheadless 1 --isplay 1 --issave 0  > log/logplay9127.txt
start /B python action_video.py --ip 127.0.0.1:9128 --isheadless 1 --isplay 1 --issave 0  > log/logplay9128.txt
start /B python action_video.py --ip 127.0.0.1:9129 --isheadless 1 --isplay 1 --issave 0  > log/logplay9129.txt
